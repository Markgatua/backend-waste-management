...
SELECT organizations.*,uploads.path as file_path,users.first_name,users.id as user_id,users.last_name,users.email,countries.id as country_id , countries.name as country from organizations 
