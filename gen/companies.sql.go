...
SELECT
    companies.id, companies.name, companies.country_id, companies.company_type, companies.organization_id, companies.region, companies.location, companies.administrative_level_1_location, companies.lat, companies.lng, companies.is_active, companies.created_at, companies.contact_person1_first_name, companies.contact_person1_last_name, companies.contact_person1_phone, companies.contact_person1_email, companies.contact_person2_email, companies.contact_person2_first_name, companies.contact_person2_last_name, companies.contact_person2_phone,
...
SELECT companies.id, companies.name, companies.country_id, companies.company_type, companies.organization_id, companies.region, companies.location, companies.administrative_level_1_location, companies.lat, companies.lng, companies.is_active, companies.created_at, companies.contact_person1_first_name, companies.contact_person1_last_name, companies.contact_person1_phone, companies.contact_person1_email, companies.contact_person2_email, companies.contact_person2_first_name, companies.contact_person2_last_name, companies.contact_person2_phone, organizations.name AS organization_name --, counties.name AS county
FROM
    companies
    LEFT JOIN organizations ON organizations.id = companies.organization_id
...
select id, name, country_id, company_type, organization_id, region, location, administrative_level_1_location, lat, lng, is_active, created_at, contact_person1_first_name, contact_person1_last_name, contact_person1_phone, contact_person1_email, contact_person2_email, contact_person2_first_name, contact_person2_last_name, contact_person2_phone from companies where lower(name) = $1 and organization_id = $2
`
...
values (
    ...
    ) returning id, name, country_id, company_type, organization_id, region, location, administrative_level_1_location, lat, lng, is_active, created_at, contact_person1_first_name, contact_person1_last_name, contact_person1_phone, contact_person1_email, contact_person2_email, contact_person2_first_name, contact_person2_last_name, contact_person2_phone
`
