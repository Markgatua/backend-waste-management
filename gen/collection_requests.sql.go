...
SELECT 
    collection_requests.id, collection_requests.producer_id, collection_requests.collector_id, collection_requests.request_date, collection_requests.pickup_date, collection_requests.status, collection_requests.created_at,
...
SELECT id, producer_id, collector_id, request_date, pickup_date, status, created_at
...
insert into collection_requests( producer_id,collector_id,request_date ) values ($1, $2, $3) returning id, producer_id, collector_id, request_date, pickup_date, status, created_at
`
